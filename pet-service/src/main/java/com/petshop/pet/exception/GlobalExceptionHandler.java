...
import com.petshop.pet.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handlePetNotFound(
    ...
    public ResponseEntity<ErrorResponseDTO> handleSpeciesNotFound(
            SpeciesNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleDuplicateSpecies(
            DuplicateSpeciesException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleSpeciesInUse(
            SpeciesInUseException ex, HttpServletRequest request) {
